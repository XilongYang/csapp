...
int tsub_ok(int x, int y) {
    ...
    // Result is overflow only if the sign of x not equals the sign of y, and the sign of x not equals the sign of result.
    // Yield 1 when it's overflow, and 0 otherwise.
